      ...
      <div className="flex flex-col sm:grid h-auto w-[90vw] sm:w-[50vw] sm:grid-cols-12 sm:grid-rows-2 sm:gap-2 relative">
        <div className="Left sm:col-span-7 sm:row-span-2">
          <div className="A bg-[#34495e] mb-2 p-3 space-x-5 justify-between All items-center ">
            ...
            <div className="P-1 bg-white rounded-full h-[100px] w-[100px] flex justify-center items-center overflow-hidden">
          ...
          <div className="B bg-[firebrick] p-3 flex All justify-between text-center">
            <div className="B1">
              <p>Total</p>
              <p>{API.length}</p>
            </div>
        ...
        <div className="Right sm:col-span-5 sm:row-span-2">
          <div className="C bg-[black] h-[30vh] sm:h-[100%] p-3 sm:w-max sm:max-h-[100%] All flex-col overflow-scroll w-[90vw] mt-2 sm:mt-0 absolute">
            {API.map((Elem, Ind) => {
              return (
                <div>
                  <p className="text-[white]">Question # {Ind + 1}</p>
                  <p className="text-[firebrick]">
